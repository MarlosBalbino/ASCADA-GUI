...
class UI_application_page_3:
    ...
    def add_widget(self):
        ...
        chart_title = 'Sines'
        ts_chart = TSChart(DataGateway.ts_data, DataGateway.ts_info, title=chart_title)
        ...
        self.scroll_area.verticalScrollBar().rangeChanged.connect(scroll_down)
